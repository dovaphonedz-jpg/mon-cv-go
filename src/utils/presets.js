const BASE = { qualities: [], languages: [], projects: [] };

export const PRESETS = {
  'modele-cv-comptable-word': {
    ...BASE,
    personal: { name: 'Sophie Laurent', title: 'Comptable Confirmée', email: 'sophie.laurent@email.com', phone: '06 12 34 56 78', address: 'Lyon, France', website: '', photo: '' },
    ...
    experiences: [
      { id: '1', role: 'Comptable', company: 'Cabinet Expertise 360', current: true, startDate: '2020', endDate: '', desc: '- Tenue complète de la comptabilité pour 40 clients (TPE/PME)\n- Établissement des déclarations fiscales (TVA, IS, CVAE)\n- Préparation des bilans et des liasses fiscales' },
  ...
  'modele-cv-ingenieur': {
    ...BASE,
    personal: { name: 'Marc Dupont', title: 'Ingénieur Informatique', email: 'marc.dupont@email.com', phone: '06 98 76 54 32', address: 'Paris, France', website: 'github.com/marcdupont', photo: '' },
    summary: "Ingénieur logiciel passionné par le développement d'architectures scalables et le cloud computing. Plus de 3 ans d'expérience en développement web fullstack (React / Node.js). Fort esprit d'analyse et travail en équipe agile.",
    experiences: [
  ...
  'modele-cv-debutant': {
    ...BASE,
    personal: { name: 'Lucas Martin', title: "À la recherche d'un premier emploi", email: 'lucas.martin@email.com', phone: '07 11 22 33 44', address: 'Toulouse, France', website: '', photo: '' },
  ...
  'modele-cv-etudiant': {
    ...BASE,
    personal: { name: 'Chloé Dubois', title: 'Étudiante en Recherche de Stage', email: 'chloe.dubois@email.com', phone: '06 55 44 33 22', address: 'Lille, France', website: '', photo: '' },
  ...
  'modele-cv-commercial': {
    ...BASE,
    personal: { name: 'Thomas Bernard', title: 'Commercial Terrain B2B', email: 'thomas.b@email.com', phone: '06 44 55 66 77', address: 'Bordeaux, France', website: 'linkedin.com/in/tbernard', photo: '' },
    summary: "Commercial B2B orienté résultats avec 4 ans d'expérience dans la vente de solutions logicielles. Reconnu pour ma force de persuasion et ma capacité à fidéliser un portefeuille client complexe. Objectif dépassé de 120% en 2023.",
    experiences: [
