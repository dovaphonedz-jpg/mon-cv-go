...
export default function TemplateGallery() {
  ...
  const cvTemplates = [
    ...
    { id: "miamivice", type: "cv", name: "CV Miami Vice", isNew: true, path: "/create?template=miamivice&demo=true", color: 'fuchsia' },
    { id: "executivegrid", type: "cv", name: "CV Executive Grid", isNew: true, path: "/create?template=executivegrid&demo=true", color: 'indigo' }
  ];
  ...
  return (
    <section id="modeles-galerie" data-nosnippet className="py-24 bg-slate-950 border-y-8 border-slate-900">
