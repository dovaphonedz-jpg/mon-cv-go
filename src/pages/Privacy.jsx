...
export default function Privacy() {
  return (
    <>
    <SEO title="Politique de Confidentialité" description="Politique de confidentialité et gestion des données personnelles de Mon CV Go." url="https://moncvgo.com/confidentialite" />
